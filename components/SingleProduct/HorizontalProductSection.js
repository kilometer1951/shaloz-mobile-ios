...
const HorizontalProductSection = (props) => {
  ...
  const renderItem_other_items = dataN.map((result, index, array) => {
    ...
    return (
      <TouchableOpacity key={index} onPress={pressAction.bind(this,result.product._id)}>
          ...
          <View style={{padding: 7}}>
            ...
            <View style={{flexDirection: 'row'}}>
              <View style={{width: '60%'}}>
                ...
                {result.product.main_category.trunc(10)}
                </Text>
              </View>
    ...
    <View style={styles.otherItems}>
      ...
      <ScrollView
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <TouchableWithoutFeedback onPress={() => props.navigation.navigate("RecentlyViewed")}>
            <View
              style={{
                flexDirection: 'row',
                marginLeft: 50,
